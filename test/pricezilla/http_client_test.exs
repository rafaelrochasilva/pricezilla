defmodule Pricezilla.HttpClientTest do
  use ExUnit.Case, async: true

  alias Pricezilla.HttpClient
  ...
  test "returns a list of products" do
    ...
    assert HttpClient.get(FakeHttpClient, url) == {:ok, products}
  end
  ...
  test "returns error when a given key is not provided" do
    ...
    assert HttpClient.get(FakeHttpClient, url) == {:error, message}
  end
end
